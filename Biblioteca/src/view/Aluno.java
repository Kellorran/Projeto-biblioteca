...
public class Aluno extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.dispose();
        AdmUser sedux = new AdmUser();
        sedux.setVisible(true);
    }//GEN-LAST:event_jButton1ActionPerformed


    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (txtMatricula.getText().equals("usuario")&&(new String(txtSenha.getPassword())).equals("abc")){
            EscolhasParaMenuAluno nova = new EscolhasParaMenuAluno(null,true);
            this.dispose();
